 ...
 *   https://datatables.net/download/#bs5/moment-2.29.4/dt-2.3.4/date-1.6.1
 *
 * Included libraries:
 *   Moment 2.29.4, DataTables 2.3.4, DateTime 1.6.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/moment-2.29.4/dt-2.3.4/date-1.6.1",
